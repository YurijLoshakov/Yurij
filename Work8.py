...
class Calculator:
    ...
    def mult(self, digit, digit2):
        print(int(digit * digit2))

    def division(self, digit, digit2):
    ...
    def process(self, enter):
        while (enter != "stop"):
            if (enter == "+"):
                ...
                self.mult(int(input("Первое число: ")), int(input("Второе число: ")))
            elif (enter == "/"):
                self.division(float(input("Первое число: ")), float(input("Второе число: ")))
            elif (enter == "**"):
